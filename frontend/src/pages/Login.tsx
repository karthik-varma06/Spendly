...
export default function Login() {
  ...
  return (
    <div className="relative min-h-[calc(100vh-88px)] overflow-hidden px-4 py-8">
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_top_left,_rgba(96,165,250,0.16),_transparent_32%),radial-gradient(circle_at_bottom_right,_rgba(168,85,247,0.14),_transparent_30%)]" />

      <div className="mx-auto grid min-h-[calc(100vh-104px)] max-w-7xl items-center lg:grid-cols-[1.05fr_0.95fr]">
        <div className="hidden pr-6 lg:block">
          ...
          >
            ...
            <motion.p variants={itemVariants} className="max-w-xl text-base leading-7 text-[var(--muted)]">
              Log in to review uploads, track expenses, open AI insights, and keep everything in one polished workspace.
            </motion.p>
          </motion.div>
        </div>
